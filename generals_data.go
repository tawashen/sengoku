...
func (m *model) InitializeGenerals() map[string]*General {
	...
	data := []General{
		...
		{Name: "山本勘助", Combat: 1, PlusCombat: 1, Politics: 0, Prestige: 0, Stipend: 1, Loyalty: 1},
		...
		{Name: "竹中半兵衛", Combat: 1, PlusCombat: 1, Politics: 2, Prestige: 1, Stipend: 1, Loyalty: 2},
		...
		{Name: "黒田孝高", Combat: 1, PlusCombat: 1, Politics: 3, Prestige: 1, Stipend: 2, Loyalty: 0},
		{Name: "明智光秀", Combat: 5, Politics: 4, Prestige: 3, Stipend: 5, Loyalty: 0, PlusLoyalty: -2},
		{Name: "足利義昭", Combat: 0, Politics: 0, Prestige: 1, PlusPrestige: 2, Stipend: 8, Loyalty: 0, PlusLoyalty: -2},
